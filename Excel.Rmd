...
Für das neu angelegte Workbook wird nun ein Sheet generiert:
...
In ein definiertes Sheet können nun mit writeData() Daten geschrieben werden. 
...
writeData(wb, "Datenpruefung", x = "Wert auswählen", startCol = 1, startRow = 6)

dataValidation(wb, "Datenpruefung", cols = 2, rows = 6, type = "list", value = "'Dropdown'!$A$1:$A$3")

# Feld das überprüft wird grau hervorheben
addStyle(wb, "Datenpruefung", cols = c(2, 2, 2), rows = c(2, 4, 6), style = style_grau)
