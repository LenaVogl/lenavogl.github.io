...
In ein definiertes Sheet können nun mit writeData() Daten geschrieben werden. Die Formatierung kann mit dem Befehl createStyle() definiert und anschließend mit addStyle() angewendet werden.
