...
Immer wieder kommt es vor, dass Daten für andere Nutzer in Excel exportiert werden müssen. Mit dem Package openxlsx lassen sich die Daten nicht nur abspeichern, es können auch  sämtliche Formatierungen vorgenommen werden. Damit eignet sich das Package meiner Meinung nach perfekt zur automatisierten Erstellung von Exceldateien. Mit relativ geringem Aufwand können die Daten z.B. auch per Schleifen in verschiedene Excelsheets geschrieben werden.
